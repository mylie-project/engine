...
public interface Vec2<V extends Vec2<V, N>, N extends Number> extends Vec<V, N> {
	...
	/**
	 * Returns a new vector with both components set to the x-coordinate of this
	 * vector.
	 *
	...
	/**
	 * Returns a new vector with both components set to the y-coordinate of this
	 * vector.
	 *
	...
	/**
	 * Returns a new vector with the x-coordinate in the y-position and the
	 * y-coordinate in the x-position.
	 *
