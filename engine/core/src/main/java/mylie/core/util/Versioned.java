...
/**
 * A generic class that represents a value with an associated version. The version
 * tracks changes to the value, enabling updates and comparisons of versions.
 *
 * @param <T> The type of the value being stored and tracked.
 */
...
public class Versioned<T> {
    ...
    /// Creates and returns a snapshot reference to the current state of this Versioned object.
    /// The reference includes the current value and version of the object.
    ///
    /// @return a new Reference object encapsulating the current value and version of this Versioned object.
    public final Reference<T> reference(){
        return new Reference<>(this,value,version);
    }

    /// Represents a reference to a value and its version, originating from a [Versioned] object.
    /// This class provides mechanisms to check if the reference value has changed and to update
    /// the reference to match the current value and version of the source [Versioned] object.
    ///
    ...
    public static final class Reference<T>{
        ...
        /// Determines whether the version of the referenced value has changed compared to the
        ...
        /// Updates the reference value and version to match the current state of the associated
        /// `Versioned` object if the version has changed.
        ///
        /// @return true if the reference was updated (i.e., the version had changed); false otherwise.
        ...
        /// @return the value currently referenced by this object, or the updated value if
