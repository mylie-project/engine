...
public class Flags {
    ...
    ///
    /// @param flag the flag to be set. Each flag should be represented as a unique bit
    ...
    ///
    /// @param flag the flag to check. Each flag should be represented as a unique bit
    ///             to avoid conflicts with other flags.
    ...
    /// Clears the specified flag from the current flags using a bitwise AND operation
