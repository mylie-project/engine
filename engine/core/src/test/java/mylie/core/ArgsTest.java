...
public class ArgsTest {
    ...
    /**
     * Verifies functionality of the Args class and its defined method.
     * The defined method checks if a specified key exists in the arguments and is set to "defined".
     */
